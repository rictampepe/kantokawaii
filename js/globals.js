...
var Categories = [];
var Products = [];
var ShoppingCartName = "KawaiiShoppingCart";
        ...
        $.ajax({
            ...
            success: function(data) {
                $.each(data, function(_idx, item) {
                    ...
                    $("#modal-category").append("<li><a href='#' class='single-cat-item'><div class='icon'><img src='images/category/" + item.categoryId + ".svg' alt=''></div><div class='text'>" + item.name + "</div></a></li>");

                    if (categorySlider.length) {
                        categorySlider.append("<div class='item'><a href='shop_grid.html' class='category-item'><div class='cate-img'><img src='images/category/" + item.categoryId + ".png'></div><h4>" + item.name + "</h4></a></div>");
                    }
                });
